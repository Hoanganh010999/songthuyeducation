        ...
        >
          ...
          <div class="flex-1">
            <div class="flex items-center gap-2">
              <p class="font-medium text-gray-900">{{ account.name || account.zalo_id }}</p>
              <span
                v-if="account.is_active"
                class="px-2 py-0.5 text-xs font-medium rounded-full bg-blue-600 text-white"
              >
                ✓ {{ t('zalo.selected') }}
              </span>
              <span 
            ...
            <p class="text-sm text-gray-600">{{ account.phone || account.zalo_id }}</p>
            <div v-if="account.branch || account.assigned_user" class="mt-1 flex items-center gap-2 text-xs text-gray-500">
              <span v-if="account.branch">
                {{ t('common.branch') }}: {{ account.branch.name }}
              </span>
              <span v-if="account.assigned_user">
          ...
          <div class="flex items-center gap-2">
            <button
              ...
              class="px-3 py-1.5 text-sm text-purple-600 border border-purple-600 rounded-lg hover:bg-purple-50"
            ...
            <button
              ...
              class="px-3 py-1.5 text-sm text-orange-600 border border-orange-600 rounded-lg hover:bg-orange-50 disabled:opacity-50"
            >
            ...
            <button
              ...
              class="px-3 py-1.5 text-sm text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50"
            >
