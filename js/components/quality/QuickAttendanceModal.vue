...
const loadAttendanceData = async () => {
  ...
  try {
    ...
    const response = await axios.get(`/api/quality/classes/${props.classData.id}/sessions/${props.session.id}/attendance`);
...
const saveAttendance = async () => {
  ...
  try {
    ...
    const response = await axios.post(
      `/api/quality/classes/${props.classData.id}/sessions/${props.session.id}/attendance`,
      payload
    );
