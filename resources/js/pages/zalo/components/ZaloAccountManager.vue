          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                ...
                <!-- Delete button (only for users with manage_accounts permission) -->
                <button
                  v-if="canManageAccounts"
...
onMounted(() => {
  ...
  // Listen for account status updates (when sessions are validated)
  window.addEventListener('zalo-accounts-status-updated', () => {
    console.log('🔄 [ZaloAccountManager] Reloading accounts after status update...');
    loadAccounts();
  });
});
</script>
