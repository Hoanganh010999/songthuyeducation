      ...
      <div class="flex justify-between items-center">
        ...
        <div class="flex gap-2">
          ...
          >
            ...
            <span v-if="!refreshing">Làm mới bản dịch</span>
...
const refreshTranslations = async () => {
  ...
  try {
    ...
    await loadTranslations(currentLanguageCode.value || 'vi');
    
    swal.success('Đã làm mới bản dịch thành công!');
    ...
    swal.error('Có lỗi xảy ra khi làm mới bản dịch');
  } finally {
